package com.CanonERP.kakaoworkagent.controller;
...
import com.CanonERP.kakaoworkagent.domain.Agent;
import com.CanonERP.kakaoworkagent.domain.ChangedUser;
import com.CanonERP.kakaoworkagent.domain.Content;
import com.CanonERP.kakaoworkagent.domain.Content1;
import com.CanonERP.kakaoworkagent.domain.Content2;
import com.CanonERP.kakaoworkagent.domain.Hello;
import com.CanonERP.kakaoworkagent.domain.MetadataVo;
import com.CanonERP.kakaoworkagent.domain.Param;
import com.CanonERP.kakaoworkagent.domain.Profile;
import com.CanonERP.kakaoworkagent.domain.Report;
import com.CanonERP.kakaoworkagent.domain.ReportVo;
import com.CanonERP.kakaoworkagent.domain.UserExtra;
import com.CanonERP.kakaoworkagent.domain.Valid;
import com.CanonERP.kakaoworkagent.domain.ValidUser;
import com.CanonERP.kakaoworkagent.domain.ValidVo;
import com.CanonERP.kakaoworkagent.domain.agentVo;
import com.CanonERP.kakaoworkagent.domain.departments;
import com.CanonERP.kakaoworkagent.domain.editability;
import com.CanonERP.kakaoworkagent.domain.idreturn;
import com.CanonERP.kakaoworkagent.domain.more_telephones;
import com.CanonERP.kakaoworkagent.domain.more_telephones1;
import com.CanonERP.kakaoworkagent.domain.orgunit;
import com.CanonERP.kakaoworkagent.domain.synchronize_options;
import com.CanonERP.kakaoworkagent.domain.telephones;
import com.CanonERP.kakaoworkagent.exeption.MissingRequiredHeaderException;
import com.CanonERP.kakaoworkagent.orgunits.domain.ChangeOrgContent;
import com.CanonERP.kakaoworkagent.orgunits.domain.ChangeOrgVo;
import com.CanonERP.kakaoworkagent.orgunits.domain.PosiContent;
import com.CanonERP.kakaoworkagent.orgunits.domain.PositionVo;
import com.CanonERP.kakaoworkagent.orgunits.domain.ResponsContent;
import com.CanonERP.kakaoworkagent.orgunits.domain.ResponsibilIo;
import com.CanonERP.kakaoworkagent.orgunits.domain.ResponsibilVo;
import com.CanonERP.kakaoworkagent.orgunits.domain.VaContent;
import com.CanonERP.kakaoworkagent.orgunits.domain.ValidunitIo;
import com.CanonERP.kakaoworkagent.orgunits.domain.ValidunitVo;
